              ...
              <div key={ing._id} className="ingredient-card">
                <div className="card-header" style={{ borderBottom: 'none', padding: '1.25rem 1.25rem 0.5rem 1.25rem' }}>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
                    <span className={`badge ${getCategoryBadgeClass(ing.category)}`} style={{ alignSelf: 'flex-start', fontSize: '0.65rem', fontWeight: 800 }}>
                      {ing.category}
                    </span>
            ...
            <form onSubmit={handleAddSubmit}>
              ...
              <div className="form-row">
                ...
                <div className="form-group">
                  ...
                  <input type="text" className="form-control" required value={unit} onChange={e => setUnit(e.target.value)} placeholder="kg, liters, boxes" />
                </div>
              </div>
              ...
              <div className="form-group">
                <label className="form-label">Storage Temperature Class</label>
              ...
              <div className="form-group" style={{ marginTop: '1.25rem' }}>
                <label style={{ display: 'flex', alignItems: 'flex-start', gap: '0.5rem', cursor: 'pointer', fontSize: '0.8rem', color: 'var(--text-secondary)' }}>
                  <input 
                    ...
                    style={{ marginTop: '0.15rem' }}
                  />
                  <span>I declare under penalty of status demotion that this food is clean, correctly stored, matches packaging parameters, and is safe for immediate delivery and intake.</span>
                </label>
              </div>
